...
app.listen(process.env.PORT || 4000, process.env.MYHOST || '0.0.0.0', () => console.log("Server listening on port 4000")) // que comienze a escuchar en puerto 4000, una vez escuchado ejecutar función
